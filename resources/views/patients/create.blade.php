                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="health_insurance" name="health_insurance" type="text" class="mt-1 block w-full" :value="old('health_insurance')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="health_insurance_number" name="health_insurance_number" type="text" class="mt-1 block w-full" :value="old('health_insurance_number')" />
                                ...
                                <div>
                                    ...
                                    <textarea id="chronic_diseases" name="chronic_diseases" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('chronic_diseases') }}</textarea>
                                    <x-input-error class="mt-2" :messages="$errors->get('chronic_diseases')" />
                                </div>

                                <div>
                                    <x-input-label for="medications" value="Medicações em Uso" />
                                    <textarea id="medications" name="medications" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('medications') }}</textarea>
